...
echo "Creating vm"
sudo wget -O /etc/libvirt/qemu/Windows10.xml https://github.com/yoanndelattre/Windows-Deployer-KVM/raw/master/scripts-install/assets/windows10_vm_template_initial.xml
